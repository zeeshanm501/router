...
function Diary(props) {
    let filterList = props.details.filter((e) => { return e.title == "T-shirt" })
    return (
        <div style={{ marginTop: '120px' }}>
            <Typography variant='h2' my={6} sx={{ textShadow: "2px 2px 6px grey", color: '#DC3545', fontStyle: "italic", fontWeight: 'bold', textAlign: 'center' }}>Diary</Typography>
